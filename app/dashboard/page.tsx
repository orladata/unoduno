        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm lg:text-base text-white/60 leading-relaxed">
              Cole um link de vídeo do YouTube para extrair a transcrição completa e obter insights detalhados sobre o conteúdo.
            </p>
          </div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm lg:text-base font-bold text-white">
                {creditsRemaining} análise{creditsRemaining !== 1 ? "s" : ""}
              </span>
            </div>
          ...
          >
            {[
              ...
              { icon: "🔍", label: "Análise Detalhada" },
              { icon: "💾", label: "Download", sub: "TXT/VTT" },
