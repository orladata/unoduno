...
- Name: homepage.spec.ts >> Homepage >> should accept valid YouTube URL and redirect
- Location: e2e\homepage.spec.ts:33:7
...
Expected pattern: /\/analisar\?url=/
Received string:  "http://localhost:3000/"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    22 × unexpected value "http://localhost:3000/"
